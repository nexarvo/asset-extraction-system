...
} from '../entities/duplicate-cluster.entity';
...
export class DuplicateClusterRepository {
  ...
  async create(
    data: Partial<DuplicateClusterEntity>,
  ): Promise<DuplicateClusterEntity> {
  ...
  async findByStatus(
    ...
    return this.repository.find({
      ...
      } as FindOptionsWhere<DuplicateClusterEntity>,
    });
  }
  ...
  async findAll(options?: {
    skip?: number;
    take?: number;
  }): Promise<[DuplicateClusterEntity[], number]> {
